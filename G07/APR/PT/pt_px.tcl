...
set link_library  "  * $target_library  \
                       dw_foundation.sldb "
read_verilog  ../icc/post_layout/lenet_layout.v
current_design  lenet
link
read_sdc ../icc/post_layout/lenet_layout.sdc
read_parasitics ../icc/post_layout/lenet_layout.max.gz

read_vcd ../post_sim/post_sim.fsdb -strip_path test_top/lenet0

check_power
update_power
report_power  -hier > time_wo_sdc_hier.rpt
report_power  > time_wo_sdc_report.rpt
exit
