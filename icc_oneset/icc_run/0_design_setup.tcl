...
create_mw_lib  -technology /usr/cadtool/cad/synopsys/SAED32_EDK/tech/milkyway/saed32nm_1p9m_mw.tf -mw_reference_library {/usr/cadtool/cad/synopsys/SAED32_EDK/lib/stdcell_hvt/milkyway/saed32nm_hvt_1p9m} -bus_naming_style {[%d]}  -open  lenet

import_designs -format verilog -top lenet -cel lenet {../pre_layout/design_data/lenet_syn.v}

read_sdc  -version Latest "../pre_layout/design_data/lenet_syn.sdc"
