...
set HDL_DIR "../hdl"
analyze -library $TOPLEVEL -format verilog "$HDL_DIR/conv2_top.v \
											$HDL_DIR/conv2_control.v \
											$HDL_DIR/conv2_bias_sel.v \ 
											$HDL_DIR/conv2_data_reg.v \
											$HDL_DIR/conv2_multiply_compare.v \
											$HDL_DIR/conv2_quantize.v"
